...
--
-- Name: main_image; Type: TABLE; Schema: public; Owner: myprojectuser
--
...
ALTER TABLE public.main_image OWNER TO myprojectuser;

--
-- Name: main_image_id_seq; Type: SEQUENCE; Schema: public; Owner: myprojectuser
--
...
ALTER TABLE public.main_image_id_seq OWNER TO myprojectuser;

--
-- Name: main_image_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: myprojectuser
--
...
--
-- Name: main_image id; Type: DEFAULT; Schema: public; Owner: myprojectuser
--
...
1	pbkdf2_sha256$216000$FmAfHlhNVz49$0W2wWa3VXRSJ+8jTzc5dzCKbbbofJN/9hiv32rcxW+M=	2020-09-18 17:11:15.177902+06:30	t	admin			shunainghtet98@gmail.com	t	t	2020-09-03 15:32:09.563263+06:30
\.
...
204	2020-09-18 15:04:30.790344+06:30	1	Image object (1)	1	[{"added": {}}]	13	1
205	2020-09-18 15:04:41.584227+06:30	2	Image object (2)	1	[{"added": {}}]	13	1
206	2020-09-18 15:04:51.088399+06:30	3	Image object (3)	1	[{"added": {}}]	13	1
207	2020-09-19 13:46:59.53766+06:30	58	Product object (58)	1	[{"added": {}}]	11	1
208	2020-09-19 13:48:03.439162+06:30	4	Image object (4)	1	[{"added": {}}]	13	1
209	2020-09-19 13:48:13.322784+06:30	5	Image object (5)	1	[{"added": {}}]	13	1
210	2020-09-19 13:49:06.725009+06:30	6	Image object (6)	1	[{"added": {}}]	13	1
211	2020-09-19 15:17:00.085444+06:30	10	Product object (10)	2	[{"changed": {"fields": ["Product description"]}}]	11	1
\.
...
--
-- Data for Name: main_image; Type: TABLE DATA; Schema: public; Owner: myprojectuser
--
...
58	Xiaomi Redmi 9i	1020.00	images/redmi9i1.jpg	Android smartphone. Announced Sep 2020. Features 6.53″ IPS LCD display, MediaTek Helio G25 chipset	5	1
10	iPhone XS	880.00	images/MTFD2_AV1_GOLD_GEO_HK.jpeg	Most Advanced iPhone Ever Features a 5.8-Inch and 6.5-Inch All-Screen Design, with Powerful A12 Bion	1	1
\.
...
SELECT pg_catalog.setval('public.django_admin_log_id_seq', 211, true);
...
--
-- Name: main_image_id_seq; Type: SEQUENCE SET; Schema: public; Owner: myprojectuser
--
...
SELECT pg_catalog.setval('public.main_product_id_seq', 58, true);
...
--
-- Name: main_image main_image_pkey; Type: CONSTRAINT; Schema: public; Owner: myprojectuser
--
